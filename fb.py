...
def exit():
	os.system('clear')
	print "\033[1;91mroot ~ Join my facebook..."
	os.system('sleep 3 && clear')
	os.system('xdg-open https://www.facebook.com/profile.php?id=100069673004485/')
	os.sys.exit()
        tool_main_function()
...
\033[1;97m╔════════════════════════════════════════╗
\033[1;97m║\033[1;93m* \033[1;97mDevlop By: \033[1;91m: \033[1;96mMr.01y       \033[1;97m            ║
...
def tool_main_function():
	...
	print "\033[1;97m║"
	login_method = raw_input("\033[1;97m╚═\033[1;91mroot@Mr.01y ~ \033[1;97m")
	if login_method =="":
...
#-
def choices():
	pick = raw_input("\033[1;97m╚═\033[1;91mroot@Mr.01y ~ \033[1;97m")
	if pick =="":
		print "\033[1;91m[!] Wrong input"
		choices()
	elif pick =="1":
...
#-----choices
def choose_dump():
	choose_from = raw_input("\033[1;97m╚═\033[1;91mroot@Mr.01y ~ \033[1;97m")
	if choose_from =="":
		print "\033[1;91m[!] Wrong input"
		choose_dump()
	elif choose_from =="1":
...
#----choices
def choose_hack():
	hack = raw_input("\033[1;97m╚═\033[1;91mroot@Mr.01y ~ \033[1;97m")
	if hack=="":
		print "\033[1;91m[!] Wrong input"
		choose_hack()
	elif hack =="1":
...
def choices_super():
	peak = raw_input("\033[1;97m╚═\033[1;91mroot@Mr.01y ~ \033[1;97m")
	if peak =="":
		print "\033[1;91m[!] Wrong input"
		choices_super()
	elif peak =="1":
